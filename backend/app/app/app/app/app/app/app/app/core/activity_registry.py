...
ACTIVITY_REGISTRY: dict[str, ActivityDefinition] = {
    ...
    "APPLICATION_OTHER": ActivityDefinition(
        activity_code="APPLICATION_OTHER",
        activity_name="Application Support (General)",
        description="Login/access issues, performance problems, feature requests, configuration changes",
        technical_scope="application",
        allowed_for_user_request=True,
        restricted_operation=False,
        required_role_for_execution="agent",
        ...
        downtime_required=False,
        downtime_description="No Downtime",
        customer_summary="Day-to-day user support for account troubleshooting and feature guidance.",
        customer_analogy="Standard assistance from our support staff to keep your daily work moving smoothly.",
        prerequisites=[
            "Valid user account and authentication credentials.",
            "Clear description of the encountered application behavior.",
        ],
        risk_warning="None.",
        approval_workflow="direct_to_agent",
    ),
